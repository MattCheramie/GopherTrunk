...
redirect_from: /learn/digital-modulation/
...
In [lesson 1](/learn/rf-sdr/radio-waves/) you saw that information rides on a wave by changing
...
[Symbols, baud & bitrate](/learn/rf-sdr/symbols-and-baud/) — matters when you size capture
...
literally these deviations; on the [constellation](/learn/rf-sdr/iq-data/) they're four
...
[SNR](/learn/rf-sdr/decibels/) to decode. You'll meet it in Wi-Fi, cable, and LTE rather than
...
**[IQ data](/learn/rf-sdr/iq-data/)**: the horizontal axis (**I**) and vertical axis (**Q**)
...
lock](/learn/rf-sdr/tuning-with-scopes/) later in the path.
...
is](/learn/rf-sdr/what-is-sdr/) to see where these symbols come from.
