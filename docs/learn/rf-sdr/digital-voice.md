---
slug: digital-voice
redirect_from: /learn/digital-voice/
...
static as it weakens. **Digital voice** compresses speech with a **[vocoder](/learn/rf-sdr/vocoders/)**
into a few kilobits per second, then sends it as [digital
modulation](/learn/rf-sdr/digital-modulation/) — gaining spectrum efficiency, trunking,
...
Traditional two-way radio uses **[FM](/learn/rf-sdr/analog-modulation/)**: the audio directly
...
- **Spectrum efficiency** — narrower channels and, with [trunking](/learn/rf-sdr/what-is-trunking/),
...
- **Encryption** — optional [privacy](/learn/rf-sdr/encryption/) on sensitive talkgroups.
...
You can't send full-quality audio in the tiny [bitrate](/learn/rf-sdr/symbols-and-baud/) a
narrow digital channel provides. The solution is a **[vocoder](/learn/rf-sdr/vocoders/)** (voice
...
- **The cliff effect.** This is the big one. Analog fades smoothly; digital is
  **all-or-nothing**. As long as [error correction](/learn/rf-sdr/demodulation-pipeline/) can
...
- You need software that can both **demodulate** the digital signal and run the matching
  **vocoder** to make sound — GopherTrunk does both (see
  [antenna-to-audio](/learn/rf-sdr/antenna-to-audio/)).
...
- The **cliff effect** means a marginal system is either decoding well or not at all;
  improving [SNR](/learn/rf-sdr/decibels/) (antenna, placement, [gain](/learn/rf-sdr/gain-and-agc/)) is
  what moves you back from the cliff edge.
- **Encrypted** talkgroups are silent no matter how strong the signal — that's the
  [next-but-one lesson](/learn/rf-sdr/encryption/).
...
- The **[vocoder](/learn/rf-sdr/vocoders/)** compresses speech into a few kbps.
