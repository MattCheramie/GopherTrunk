...
[decibels](/learn/rf-sdr/decibels/). For VHF/UHF, *placement and height usually beat a
fancier antenna.*
</div>

You've learned what a wave is and how power is measured. The antenna is where the
two meet: it turns waves in the air into the faint signal your [SDR](/learn/rf-sdr/what-is-sdr/)
...
Recall *λ ≈ 300 ÷ MHz* from [lesson 1](/learn/rf-sdr/radio-waves/): plug in the frequency,
...
a fraction of a [decibel](/learn/rf-sdr/decibels/) — more at higher frequencies. Keep runs
