...
redirect_from: /learn/frequency-and-spectrum/
...
In [lesson 1](/learn/rf-sdr/radio-waves/) you learned that frequency is how fast a wave
...
[next lesson](/learn/rf-sdr/propagation/) goes deeper):
...
[waterfall](/learn/rf-sdr/fft-and-waterfall/), you already have a guess about what it is.
...
[filter width](/learn/rf-sdr/filtering-decimation/) GopherTrunk needs and explains why
...
a big reason analog gave way to [digital](/learn/rf-sdr/digital-voice/).
...
first hardware decision — see the [SDR hardware lesson](/learn/rf-sdr/sdr-hardware/) and the
