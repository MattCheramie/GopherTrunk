...
redirect_from: /learn/what-is-trunking/
...
down to getting a [clean, solid lock](/learn/rf-sdr/tuning-with-scopes/) on it.

The control-channel data itself is sent using the [digital
modulation](/learn/rf-sdr/digital-modulation/) you met earlier — for P25 and DMR, that's the 4FSK
...
landscape](/learn/rf-sdr/protocol-landscape/).
...
audio](/learn/rf-sdr/antenna-to-audio/).
