---
slug: propagation
redirect_from: /learn/propagation/
...
You've got an [antenna](/learn/rf-sdr/antennas/) sized for your band. Where you put it, and
...
[symbols](/learn/rf-sdr/digital-modulation/) and can push decoding past its error limit.
...
- **Match polarization** — vertical for most land-mobile (see [antennas](/learn/rf-sdr/antennas/)).
- **Keep coax short** to limit loss.
- **Escape noise.** Computers, USB hubs, chargers, and LED/CFL lighting raise your
  [noise floor](/learn/rf-sdr/decibels/); distance from them improves SNR more than you'd
  expect.
