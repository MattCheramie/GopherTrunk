---
slug: what-is-sdr
redirect_from: /learn/what-is-sdr/
...
3. **Deliver IQ** — those numbers come out in pairs called **[IQ samples](/learn/rf-sdr/iq-data/)**,
...
demodulates the [4FSK signal](/learn/rf-sdr/digital-modulation/), recovers the symbols, decodes
the trunking protocol to learn which voice channel a call jumped to, follows it,
decodes the [vocoded voice](/learn/rf-sdr/vocoders/), and writes you a WAV file — all in real time,
...
what the [From antenna to audio](/learn/rf-sdr/antenna-to-audio/) lesson ties together at the end.
...
and how to pick one. The [SDR hardware lesson](/learn/rf-sdr/sdr-hardware/) later in this module
