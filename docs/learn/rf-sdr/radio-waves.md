---
slug: radio-waves
redirect_from: /learn/radio-waves/
...
**[antenna](/learn/rf-sdr/antennas/)** needs to be (antennas are sized to a fraction of a
...
**power level** in decibels (you'll meet **[dBm and the noise floor](/learn/rf-sdr/decibels/)**
...
[Module 2](/learn/rf-sdr/#signals-modulation). For now, just know that the radio wave is the
...
lesson, [Frequency, bands & the spectrum](/learn/rf-sdr/frequency-and-spectrum/).
