---
slug: other-signals
redirect_from: /learn/other-signals/
...
Trunked voice is only part of what's on the air. Because an [SDR](/learn/rf-sdr/what-is-sdr/)
just delivers [IQ samples](/learn/rf-sdr/iq-data/), the *same* hardware can decode many other
...
**POCSAG** and the faster **FLEX** are [FSK](/learn/rf-sdr/digital-modulation/) paging protocols
...
[carrier](/learn/rf-sdr/signal-anatomy/) carrying [modulated](/learn/rf-sdr/digital-modulation/) data,
captured as [IQ](/learn/rf-sdr/iq-data/), pulled out by [filtering](/learn/rf-sdr/filtering-decimation/),
and [demodulated and decoded](/learn/rf-sdr/demodulation-pipeline/). Learning trunked voice gave
...
systems are quiet or [encrypted](/learn/rf-sdr/encryption/).
