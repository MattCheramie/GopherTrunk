...
redirect_from: /learn/fft-and-waterfall/
...
The **FFT (Fast Fourier Transform)** turns a block of [IQ samples](/learn/rf-sdr/iq-data/) into
...
stripe** is the tell-tale of a [control channel](/learn/rf-sdr/what-is-trunking/). No calculus
required.
</div>
...
Your SDR produces [IQ samples](/learn/rf-sdr/iq-data/) over *time*. But to *see* signals you
...
captured [bandwidth](/learn/rf-sdr/sample-rate-nyquist/). 
...
versus frequency and you have the [spectrum view](/learn/rf-sdr/signal-anatomy/); the FFT runs
...
restless baseline is the [noise floor](/learn/rf-sdr/decibels/). The **height of a peak above
that floor is its SNR at a glance** — the taller it stands, the better it'll
[decode](/learn/rf-sdr/antenna-to-audio/). Width tells you roughly what kind of signal it is
(narrow voice channel vs. wide broadcast), as covered in
[anatomy of a signal](/learn/rf-sdr/signal-anatomy/).
...
[control channel](/learn/rf-sdr/what-is-trunking/):

1. Tune to the [band](/learn/rf-sdr/frequency-and-spectrum/) the system uses.
...
3. Confirm by checking it against a [systems database](/learn/rf-sdr/finding-systems/).
