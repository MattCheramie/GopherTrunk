...
redirect_from: /learn/finding-systems/
...
To monitor a [trunked system](/learn/rf-sdr/what-is-trunking/) you first need its **control-
...
the **[waterfall](/learn/rf-sdr/fft-and-waterfall/)** by spotting the steady, always-on control
...
to listen to — specifically, a system's [control channel](/learn/rf-sdr/what-is-trunking/), the
...
- the **system type** ([P25, DMR, etc.](/learn/rf-sdr/protocol-landscape/)),
...
[waterfall](/learn/rf-sdr/fft-and-waterfall/). In the [band](/learn/rf-sdr/frequency-and-spectrum/) the
...
database entry. The [protocol landscape](/learn/rf-sdr/protocol-landscape/) lesson helps you
...
commentary](/learn/rf-sdr/what-is-trunking/), and begins following calls — exactly the
[antenna-to-audio](/learn/rf-sdr/antenna-to-audio/) flow, now pointed at a real system you
found. If the control channel won't hold a clean lock, the next two lessons —
[tuning with scopes](/learn/rf-sdr/tuning-with-scopes/) and
[calibration & troubleshooting](/learn/rf-sdr/calibration-troubleshooting/) — are where you go.
