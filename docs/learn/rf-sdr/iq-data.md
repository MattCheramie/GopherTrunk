...
[constellation diagram](/learn/rf-sdr/digital-modulation/). IQ also lets the receiver tell
...
[modulation](/learn/rf-sdr/digital-modulation/), the [constellation](/constellation.html), and
[demodulation](/learn/rf-sdr/demodulation-pipeline/) together. It looks abstract for about
...
The [quadrature-sampling receiver](/learn/rf-sdr/sdr-receiver/) produces these two channels
...
the rotation speed *is* the frequency. [Modulation](/learn/rf-sdr/digital-modulation/) nudges
...
**[constellation diagram](/learn/rf-sdr/digital-modulation/)** is. The constellation you watch
...
[tunes and filters](/learn/rf-sdr/filtering-decimation/) within that IQ to isolate a channel,
[demodulates](/learn/rf-sdr/demodulation-pipeline/) it by tracking amplitude/phase over time,
