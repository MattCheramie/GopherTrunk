...
Every term used across the [learning path](/learn/rf-sdr/), defined in plain language and
...
changes the carrier to carry a message. See [What is a radio wave?](/learn/rf-sdr/radio-waves/)
...
Higher frequency = shorter wavelength. See [What is a radio wave?](/learn/rf-sdr/radio-waves/)

**Hertz (Hz)** — The unit of frequency: one cycle per second. Common multiples are
kHz (thousand), MHz (million), and GHz (billion). See
[Frequency, bands & the spectrum](/learn/rf-sdr/frequency-and-spectrum/)

**Modulation** — Deliberately varying a carrier's amplitude, frequency, or phase to
encode information. See [Digital modulation & constellations](/learn/rf-sdr/digital-modulation/)

**Wavelength (λ)** — The physical length of one wave cycle, in metres. Approximated
for radio by *λ ≈ 300 ÷ frequency in MHz*. See [What is a radio wave?](/learn/rf-sdr/radio-waves/)

**Band** — A defined, contiguous range of frequencies assigned to a use (e.g. the FM
broadcast band). See [Frequency, bands & the spectrum](/learn/rf-sdr/frequency-and-spectrum/)
...
See [Frequency, bands & the spectrum](/learn/rf-sdr/frequency-and-spectrum/)

## Power, noise & decibels

**dB (decibel)** — A logarithmic *ratio* between two powers. +10 dB = ×10 power;
+3 dB ≈ ×2. Used for gain and loss. See [Decibels & signal power](/learn/rf-sdr/decibels/)

**dBm** — Absolute power referenced to 1 milliwatt. Received signals are negative
numbers; closer to zero is stronger. See [Decibels & signal power](/learn/rf-sdr/decibels/)

**dBFS** — Decibels relative to digital full scale, used inside the SDR. 0 dBFS is
the ADC's ceiling; real samples sit below it. See [Decibels & signal power](/learn/rf-sdr/decibels/)

**Gain** — Amplification, expressed in dB. Also the SDR setting that controls how
strong the signal is at the ADC. See [Gain, AGC & avoiding overload](/learn/rf-sdr/gain-and-agc/)
...
[Decibels & signal power](/learn/rf-sdr/decibels/)
...
each symbol carries multiple bits. See [Symbols, baud & bitrate](/learn/rf-sdr/symbols-and-baud/)

**Bit rate** — Bits per second = symbol rate × bits per symbol. See
[Symbols, baud & bitrate](/learn/rf-sdr/symbols-and-baud/)

**Symbol** — One transmitted state of the carrier, carrying one or more bits. See
[Digital modulation & constellations](/learn/rf-sdr/digital-modulation/)

**AM / FM / SSB** — Analog modulations that vary amplitude (AM), frequency (FM), or
send a single sideband (SSB). See [Analog modulation](/learn/rf-sdr/analog-modulation/)
...
QPSK uses four phases. See [Digital modulation & constellations](/learn/rf-sdr/digital-modulation/)

**QAM** — Modulation varying both phase and amplitude to pack many bits per symbol;
needs higher SNR. See [Digital modulation & constellations](/learn/rf-sdr/digital-modulation/)
...
clean signal. See [Digital modulation & constellations](/learn/rf-sdr/digital-modulation/)

**Eye diagram** — Overlaid symbol waveforms vs. time; a wide-open "eye" means good
decoding margin. See [Digital modulation & constellations](/learn/rf-sdr/digital-modulation/)

## Software-defined radio

**SDR (software-defined radio)** — A radio whose tuning, filtering, and demodulation
happen in software. See [What is software-defined radio?](/learn/rf-sdr/what-is-sdr/)

**ADC (analog-to-digital converter)** — The chip that samples the analog signal into
digital numbers. Clipping it causes distortion. See [What is SDR?](/learn/rf-sdr/what-is-sdr/)

**IQ samples** — Pairs of numbers (In-phase and Quadrature) that capture a signal's
amplitude and phase together. The SDR's output. See [IQ data & complex signals](/learn/rf-sdr/iq-data/)

**Sample rate** — How many samples per second the SDR produces; sets how much
spectrum (bandwidth) you can see at once. See
[Sample rate, bandwidth & Nyquist](/learn/rf-sdr/sample-rate-nyquist/)

**Nyquist limit** — The rule that you must sample at least twice the bandwidth you
want to capture. See [Sample rate, bandwidth & Nyquist](/learn/rf-sdr/sample-rate-nyquist/)

**Bandwidth** — The width of spectrum, in Hz, occupied by a signal or captured by a
receiver. See [Sample rate, bandwidth & Nyquist](/learn/rf-sdr/sample-rate-nyquist/)

**AGC (automatic gain control)** — Circuitry or software that adjusts gain on its own.
See [Gain, AGC & avoiding overload](/learn/rf-sdr/gain-and-agc/)

**PPM (parts per million)** — A measure of an SDR's frequency error; correcting it
aligns the radio to true frequency. See [Calibration & troubleshooting](/learn/rf-sdr/calibration-troubleshooting/)
...
filtering, tuning, demodulating. See [The demodulation pipeline](/learn/rf-sdr/demodulation-pipeline/)

**FFT (Fast Fourier Transform)** — The algorithm that turns IQ samples into a
spectrum view; the basis of the waterfall. See [The FFT & reading a waterfall](/learn/rf-sdr/fft-and-waterfall/)

**Waterfall** — A scrolling spectrum display showing signal strength across frequency
over time. See [The FFT & reading a waterfall](/learn/rf-sdr/fft-and-waterfall/)

**Filtering** — Keeping a chosen slice of spectrum and discarding the rest. See
[Filtering & decimation](/learn/rf-sdr/filtering-decimation/)
...
[What is trunked radio?](/learn/rf-sdr/what-is-trunking/)
...
not frequencies. See [What is trunked radio?](/learn/rf-sdr/what-is-trunking/)

**Affiliation** — A radio registering with the trunked system over the control
channel. See [What is trunked radio?](/learn/rf-sdr/what-is-trunking/)
...
decodes. See [The digital protocol landscape](/learn/rf-sdr/protocol-landscape/)

**Encryption** — Scrambling that prevents voice from being decoded; encrypted
talkgroups stay silent. See [Encryption & what you can decode](/learn/rf-sdr/encryption/)

**APRS / AIS / ADS-B** — Non-trunked data signals (amateur position, ship tracking,
aircraft tracking) GopherTrunk can also decode. See [Other signals you'll meet](/learn/rf-sdr/other-signals/)

---

Didn't find a term? It's probably explained in one of the
[learning-path lessons](/learn/rf-sdr/) — or open an
