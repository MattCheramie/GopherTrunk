...
**What's new since v0.4.3:**
- **RF & SDR learning hub** (#693) — a new [/learn/](https://gophertrunk.org/learn/) path from SDR newbie → operator: six modules, 30 lessons + glossary, each with a TL;DR, SVG diagrams, quizzes, an FAQ, and "use this in GopherTrunk" links. Plus dependency-free site-wide search and JS-optional calculators / progress tracking.
