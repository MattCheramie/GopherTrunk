...
func TestValidate(t *testing.T) {
	cases := []struct {
		...
		{"encrypted_calls empty ok", Config{Trunking: TrunkingConfig{EncryptedCalls: EncryptedCallsConfig{}}}, false},
		{"encrypted_calls follow ok", Config{Trunking: TrunkingConfig{EncryptedCalls: EncryptedCallsConfig{Mode: "follow"}}}, false},
		{"encrypted_calls metadata ok", Config{Trunking: TrunkingConfig{EncryptedCalls: EncryptedCallsConfig{Mode: "metadata", MetadataFollowMs: 1000}}}, false},
		{"encrypted_calls ignore ok", Config{Trunking: TrunkingConfig{EncryptedCalls: EncryptedCallsConfig{Mode: "ignore"}}}, false},
		{"encrypted_calls bad mode", Config{Trunking: TrunkingConfig{EncryptedCalls: EncryptedCallsConfig{Mode: "drop"}}}, true},
		{"encrypted_calls negative follow", Config{Trunking: TrunkingConfig{EncryptedCalls: EncryptedCallsConfig{Mode: "metadata", MetadataFollowMs: -1}}}, true},
